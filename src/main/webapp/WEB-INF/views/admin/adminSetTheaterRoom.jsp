						...
						<input type="hidden" value="${theaterNum}" name="theaterNum">
							<div class="tit-util mt40 mb10">
								...
								<div class="right">
									...
									<input id="calendar${0+i.count}" style="left: 1300px;" value="시작날짜"  name="startDay">
									<input id="calendar${4+i.count}" style="left: 1400px; " value="마지막날짜" name="endDay" >
									</p>
								</div>
								
							</div>
							<input type ="button" id= "test1" class="test${i.count}" value="테스트1">
							<input type ="button" id= "test2" class="test${i.count}" value="테스트2">
							
							<script type="text/javascript">
								$('#test1').click(function(){
									console.log($('#calendar1').val());
									})

									$('#test2').click(function(){
									console.log($('#calendar5').val());
									})
							</script>
									...
									<tbody class="timeAdd${0+i.count}">
										...
										<tr class="added">
											<th scope="row"><label for="phone"> <select
													...
													style="border: none; background-color: #f7f8f9;" name="time">
