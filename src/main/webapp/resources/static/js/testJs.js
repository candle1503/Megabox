 ...
 mbAlert = (function() {
     'use strict';
      var self	 = undefined,
        dom	  = undefined,
        settings = {
              defaultGap:	10, // 釉뚮씪�곗��� �덉씠�� 湲곕낯 媛�
              defaultHead:	45, // �덉씠�� ���댄� �곸뿭 �믪씠
              minWidth:		350, // �덉씠�� 理쒖냼 �덈퉬
              minHeight:	0 // �덉씠�� 理쒖냼 �믪씠
          },
          triggered	= undefined,
          tgtID		= undefined,
          clock		= undefined,
          ...
          dom: {
              ...
              frame:	'<section class="alert-popup" style="position:fixed; padding-top:45px; background:#fff; z-index:5006;">'+
                            '<div class="wrap">'+
                                ...
                                '<button type="button" class="btn-layer-close">�덉씠�� �リ린</button>'+
                          '</div>'+
                      '</section>',
         ...
         validates: true,
              ...
              switch (condition) {
                  ...
                  case 'C':
                    ...
                    if($('body').hasClass('body-iframe') || $('.modal-layer.on').length > 0 || $('.modal-layer2.on').length > 0 ){}
                      ...
                      (tgtID) ? $(tgtID).hide() : alert('�덉씠�댄뙘�� ID媛믪쓣 �낅젰�댁＜�몄슂.');
                      ...
                      mbAlert.dom.dim.finish().animate({opacity: 0}, 300, 'easeOutQuart', function() {
                          ...
                          // �뺤씤踰꾪듉�� �꾨Ⅴ怨� 肄쒕갚�⑥닔媛� 議댁옱�� 寃쎌슦�먮쭔 �몄텧
                  ...
                  case 'M':
                    ...
                    switch (mCase) {
                        ...
                        case 'dialogue':
                            ...
                            lyPop.querySelector('h3').innerHTML = '�뚮┝';
                            ...
                            if (settings.type === 'single') {
                                ...
                                if (typeof settings.cancel !== 'undefined' && settings.cancel !== '') {
                                    ...
                                    lyPop.querySelector('.lyclose').innerHTML = '痍⑥냼';
                                };
                            };
                              // �뺤씤 踰꾪듉 �대쫫
                            if (typeof settings.confirm !== 'undefined' && settings.confirm !== '') {
                                ...
                                lyPop.querySelector('.confirm').innerHTML = '�뺤씤';
                            };
          ...
          update: function() {
              var tw	= dS.browser.getW(), // 釉뚮씪�곗졇 �덈퉬
                  th	= dS.browser.getH(), // 釉뚮씪�곗졇 �믪씠
                  tg	= settings.defaultGap, // 釉뚮씪�곗��� �덉씠�� 湲곕낯 媛�
...
mbLayer = (function() {
    'use strict';
       var self	 = undefined,
        ...
        settings = {
               defaultGap:		10, // 釉뚮씪�곗��� �덉씠�� 湲곕낯 媛�
               defaultHead:	60, // �덉씠�� ���댄� �곸뿭 �믪씠
               minWidth:		350, // �덉씠�� 理쒖냼 �덈퉬
               minHeight:		300 // �덉씠�� 理쒖냼 �믪씠
           },
           triggered	= undefined,
           tgtID		= undefined,
           clock		= undefined,
       ...
       return {
           dom: {
               ...
               dim:	'<div class="normalStyle" style="display:none;position:fixed;top:0;left:0;background:#000;opacity:0.7;text-indent:-9999px;'+
                        'width:100%;height:100%;z-index:100;">�リ린</div>',
               root:	'body'
           },
        validates: true,
           init: function(opts) {
                    ...
                    switch (mCase) {
                        ...
                        case 'normal':
                            ...
                            .done(function(response) {
                                ...
                                lyPop.setAttribute('id', settings.id);
                                lyPop.querySelector('h3').innerHTML = '�쇰컲�덉씠�댄뙘��';
                                lyPop.querySelector('.layer-con').innerHTML = '';
...
selMovieToggle = (function() {
    ...
    return {
        dom: {
            checked:	'<a href="" class="post-check-area" title="�좏깮">'+
    ...
    return {
        dom: {
            ...
            cmt:		'<div class="balloon-space">'+
                            '<div class="balloon-cont">'+
                                '<!-- to 媛쒕컻 : �쇰컲�ъ슜�먯씪�� �섏삤�� 李�-->'+
                                '<div class="user" style="display:none;">'+
                                    '<p class="reset a-c">�ㅽ룷�쇰윭 諛� �뺤꽕/鍮꾨갑�섎뒗<br />�댁슜�� �덉뒿�덇퉴?</p>'+
                                    '<button type="button">�ㅽ룷�쇰윭�좉퀬 <i class="iconset ico-arr-right-green"></i></button>'+
                                '</div>'+
                                '<!-- to 媛쒕컻 : 湲��댁씠 蹂몄씤�쇰븣 �섏삤�� 李�-->'+
                                '<div class="writer" style="display:none;">'+
                                    '<button type="button">�섏젙</button>'+
                                    '<button type="button">��젣</button>'+
                                '</div>'+
                                '<div class="btn-close"><a href="#" title="�リ린"><img src="../../../static/pc/images/common/btn/btn-balloon-close.png" alt="�リ린"></a></div>'+
                            '</div>'+
                        '</div>'
        },
        init: function(opts) {
        ...
        toggle: function(opts) {
            var ar = arguments,
                ...
                dp = 10,		// 湲곕낯 gap
                ct = undefined, // �대┃�� 踰꾪듉
                pt = undefined, // �대┃�� 踰꾪듉 �뚯냽
                cn = undefined, // �대┃�� 踰꾪듉 醫낅쪟
                df = undefined; // �댄똻
...
mbThumGal = (function() {
    ...
    var self	=   undefined,
        ...
        target  =   {
                        ctn	 : 0, // �꾩옱 �좏깮�� �몃꽕��
                        ltn	 : undefined, // 留덉�留됱뿉 �좏깮�� �몃꽕��
                        tdft	: 4, // �몃꽕�� �몄텧 �뷀뤃�� 媛�닔
                        tdfW	: 1020, // �붾꽕�� �몄텧 留덉뒪�� �덈퉬
                        tlmt	: undefined, // �몃꽕�� 醫뚯륫�쇰줈 �щ씪吏� 諛⑹���
                        dly	 : null, // effect ���꾩븘��
                        subT	: false // �먮쭑
                    }
    return {
        ...
        setUI: function() {
            ...
            dom.subTt = '.' + dom.root + ' .a-c'; // �먮쭑
            dom.subBt = '.' + dom.root + ' .btn-more button'; // �먮쭑踰꾪듉

            if ($(dom.cell).length !== $(dom.tthum).length) {
                console.warn('slide-list�� thumb-list �대�吏� 媛쒖닔媛� �ㅻ쫭�덈떎. 媛ㅻ윭由� 紐⑤뱢�� �ㅽ뻾�� �� �놁뒿�덈떎.');
                return false;
            };

            target.twdt = $(dom.tthum).width(); // �숈쟻 �낅뜲�댄듃 �꾩슂
        ...
        subTt: function(e) {
            ...
            switch (target.subT) {
                case true:
                    lStt.show();
                    lTgt.empty().html('�먮쭑�リ린' + lNod);
                    lTgt.find('i').css({ transform: 'rotate(180deg)' });
                break;
                case false:
                    lStt.hide();
                    lTgt.empty().html('�먮쭑蹂닿린' + lNod);
                break;
            };
        },
        update: {
        ...
        slide: {
            init: function(e) {
                ...
                $(dom.thumCaption).empty().html(des); // 理쒗깭�� �꾩떆�묒뾽
...
mbSwiper = (function() {
    ...
    var self	=   undefined,
        ...
        sIdx	=   undefined,
        setting =   new Object(),
        targets =   new Array();	// �ㅼ��댄븨 �ㅻ툕�앺듃 由ъ뒪��
    return {
        dom: {
            root:	   'body',
            default:	'swobj'
        ...
        setUI: function() {
            ...
            if (initln !== setting.subopts.length) {
                console.error('DOM �붿냼 媛�닔�� SETTING OPTION 媛�닔媛� �ㅻ쫭�덈떎.');
                return false;
            };
        ...
        slide: {
            init: function(opts) {
                var drctn   =   setting.subopts[opts.key].direction,
                    ...
                    copyF   =   tgts.props.lis[0], // 泥ル쾲吏� 諛뺤뒪
                    copyL   =   tgts.props.lis[tgts.props.len - 1]; // 留덉�留� 諛뺤뒪
...
mbThCalendar = (function() {
    ...
    return {
        ...
        , events: {
            ...
            {
                // �꾩닔 Array �뺤씤 �� �쒖옉 , allPlayDates, holidaysFromServer
...
//				};
                ...
                if (setting.mnt.length > 1) {
                    setting.mnt.forEach(function(val, key) {
                        var val	 = Number(val),
                            tbtn	= dom.dateM.querySelectorAll('[month="'+ val +'"]'),
                            tyear   = tbtn[0].querySelectorAll('span')[0].innerHTML.split('��')[0],
                        ...
                        if (tbtn[tbtn.length - 1].querySelector('em').innerText === '1��') byear[1].style.opacity = 0;
                        // 泥ル쾲吏� �꾨룄
                ...
                // �쒕쾭�먯꽌 諛쏆� �좎쭨 �댄썑濡� �대룞遺덇��섍쾶 �붿궡�� 踰꾪듉 留됯린
...
mbCorpScoll = (function() {
    ...
    return {
        ...
        init: function(opts) {
            ...
            if (typeof opts !== 'undefined') for (var k in opts) setting[k] = opts[k];
            if (priority === 'MEGABOX �뚭컻') self.setUI();
        },
        setUI: function() {
...
mbMain = (function() {
    ...
    return {
        ...
        setUI: function() {
            ...
            setting.sto	 = null; // �ㅽ겕濡� ���꾩븘��
            setting.tto	 = null;
            setting.st	  = dS.browser.getST(); // �ㅽ겕濡� ��
            setting.seca	= new Array(); // 媛� �뱀뀡 蹂� offsetTop 媛� Array
...
mbImgArr = (function() {
    ...
    return {
        dom: {
            root	: 'body'
            , wrap	: undefined // �ъ뒪�� �몃꽕�� �꾩껜 ��
            , mbtn	: undefined // �붾낫湲� 踰꾪듉
            , list	: undefined // �ъ뒪�� �몃꽕�� 媛쒕퀎
            , view	: undefined // �뺣�蹂닿린 ��
            , imgc  : undefined // �뺣�蹂닿린 媛쒕퀎
        }
        , init: function(opts) {
            self	= this;
            dom	 = self.dom;
            ...
            setting.arrsO = []; // 蹂��� �� �믪씠 ����
            setting.arrsH = []; // �� 蹂� �믪씠 ����
            setting.arrsT = []; // 媛��� �믪� 以� 異붿텧��
            setting.strtR = -1; // ��
            setting.strtC = -1; // ��
            setting.talsR = undefined; // 媛��� �믪� 以�
            setting.shrtR = undefined; // 媛��� ��� 以�
            setting.trnsD = 0.2; // �몃옖吏��� ���대컢
            setting.rlcnt = 0; // �대�吏� �꾩튂 蹂�寃� �잛닔
            setting.rlArr = []; // �대�吏� �꾩튂 蹂�寃� �뺣낫
            setting.intv  = undefined; // �대�吏� �꾩튂 蹂�寃� shuffle
            setting.tmot  = undefined;
            setting.cntI  = 0;
            setting.ldlI  = 0;
            setting.zId   = undefined; // �뺣�蹂닿린�� �좏깮 id
        ...
        , events: {
            ...
            , draw: function(opts) {
                ...
                if (opts !== undefined) {
                    // 留덉�留됱뿉 �꾩튂媛� 蹂�寃쎈맂 �대�吏�媛� �덈떎硫� �먯긽蹂듦�
                ...
                for (;setting.initN < dom.list.length; setting.initN++) {
                    setting.strtC++; // 媛�濡� �댁씠 �ㅼ뭏�좊븣源뚯� 利앷�
            ...
            , checkArrange: function() {
                ...
                // 媛��� 湲댁쨪 留덉�留� �붿냼 + 媛��� 吏㏃� 以꾩씠 媛��� 湲댁쨪 蹂대떎 吏㏃쓣 寃쎌슦�먮쭔
                // + 留덉�留됱쨪留� �ъ젙��
            ...
            , setArrange: function() {
                ...
                // �대�吏� �꾩튂 蹂�寃� �� �곗씠�� ���� - 留덉�留됱쨪留� �꾩튂 蹂�寃�
                if (dom.talsE.getAttribute('reLoced') === null) {
                    cell 		= {};
                    cell.a 		= setting.arrsT; // 蹂�寃� �� array
                    cell.e 		= dom.talsE; // �꾩튂 蹂�寃쎈맂 �대�吏�
                ...
                setting.strtR = -1;	// 以� 諛붽퓞��
                setting.initR = 0;	// 媛��� 湲� 以� 異붿텧�� Array 珥덇린�붿슜
                setting.arrsT = [];	// 媛��� 湲� 以� 珥덇린��
...
$(function(){
    ...
    datepickerEvent = function datepicker() {
        ...
        $( ".datepicker" ).datepicker({
            tempHtmlShow : true, // 媛쒕컻
            allPlayDateClassName:"meagBox-selected-day", // 媛쒕컻
            allPlayDates : allPlayDates, // 媛쒕컻
            showButtonPanel : true, // 媛쒕컻
            showOn: "both", // 媛쒕컻
            buttonText: "�좎쭨 �좏깮", // css �먯꽌 諛곌꼍 泥섎━
        });
    ...
    $(document).on('click', '.tab-layer a', function(e){
        ...
        if( _hrefLeng > 0 ){
            ...
            $($(this).attr('href')).find('.ir').text($(this).text()+' �� �붾㈃ �낅땲��.');
        }
    });
    ...
    $(document).on('click', '.box-pulldown .tit .btn-toggle', function(){
        ...
        if( $(this).closest('.box-pulldown').hasClass('on') ){
            $(this).find('.ico-arr-toggle-down').text('�댁슜�リ린');
        }
        else {
            $(this).find('.ico-arr-toggle-down').text('�댁슜蹂닿린');
        }
    });
    ...
    /* �덉씠�� �앹뾽 �좉퇋 */
    var $layerIndex = 501;
    $('.modal-layer').prepend('<a href="" class="focus" >�덉씠�대줈 �ъ빱�� �대룞 ��</a>')
    ...
    $(document).on('click', '.btn-modal-open', function(e){
        ...
        if( $(this).hasClass('disabled') || $(this).hasClass('no-event') ){
            ...
            if( $('.bg-modal').length > 0 ){} // dim 泥섎━ �� 諛곌꼍�� �대� �덉쓣 ��
            else {// dim �� �꾩뿉 �놁쓣 �� 泥섏쓬 異쒕젰
                $('body').append($bgModal);
			...
			// modal-layer 濡� 濡쒓렇�명뙘�� �꾩슱�� dim 泥섎━�섎뒗 �꾩긽 �쒓굅
            ...
            // �덉씠�댁뿉 踰꾪듉�� �덇퀬 �녾퀬�� �곕씪 cont �곸뿭 議곗젅
 ...
 /* �덉씠�� �앹뾽 �좉퇋 */
    var $layerIndex = 501;
    $('.modal-layer2').prepend('<a href="" class="focus" >�덉씠�대줈 �ъ빱�� �대룞 ��</a>')
    ...
    $(document).on('click', '.btn-modal-open2', function(e){
        ...
        if( $(this).hasClass('disabled') || $(this).hasClass('no-event') ){
            ...
            if( $('.bg-modal2').length > 0 ){} // dim 泥섎━ �� 諛곌꼍�� �대� �덉쓣 ��
            else {// dim �� �꾩뿉 �놁쓣 �� 泥섏쓬 異쒕젰
                $('body').append($bgModal);
...
========================================================================== */
    ...
    if( $('.main-page').length > 0 ){
        ...
        // 硫붿씤 - �곹솕 section 留덉슦�� �대�吏� �먮룞 ��吏곸씠湲�
...
========================================================================== */
    ...
    if( $('.selectpicker').length > 0 ){
        $('.selectpicker').selectpicker({
            ...
            dropupAuto : true,
            size : 10 // �듭뀡媛� 異쒕젰 理쒕� 媛�닔 . �レ옄 �댁긽�� �ㅽ겕濡� 泥섎━ ��
        });
    }
    ...
    $(document).on('click', '.btn-more.toggle .btn', function(){
        ...
        if( $(this).closest('.btn-more').hasClass('on') ) {
            $(this).find('span').text('�リ린');
        }
        else {
            $(this).find('span').text('�붾낫湲�');
        }
...
========================================================================== */
    ...
    // �덈ℓ - �곸쁺�쒓컙�� - �곹솕蹂�, 洹뱀옣蹂�, �밸퀎愿� �덉そ�� �곷떒 tab �덉씠��
...
========================================================================== */
    ...
    // �섏쓽 硫붽�諛뺤뒪 - 媛쒖씤�뺣낫 �섏젙 - �곕쾲�� 蹂�寃� 痍⑥냼
        ...
        if( $(document).find('.page-util').length > 0 ) {
            ...
            if( $(document).find('.tab-list.fixed').length > 0 ) {
                ...
                if( $(document).find('.movie-detail-page').length > 0 ) {
                    ...
                    // �곹솕 �곸꽭 �댁슜 怨좎젙 �쒗궎湲�, 濡쒖��댁뀡 蹂댁씠怨� 怨좎젙�쒗궎湲�
