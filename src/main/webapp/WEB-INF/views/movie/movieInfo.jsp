...
<head>
    ...
    </script><script src="/static/pc/js/ui.common.js?v=1592877899585"></script><script src="//cast.imp.joins.com/head/GsTA6yUG5rxDcxq-bCs69ySQ3Ew5BpVUzMmjvvbBvKyEAM4qWzAZAbZCZVNSS0xPM1RUU1pieUZJdVE0SXdnAstB17oOYLgMKAPLQde6DmC4DCg.js?url=https%3A%2F%2Fwww.megabox.co.kr%2Fmovie-detail%3FrpstMovieNo%3D20019200&amp;ref=https%3A%2F%2Fwww.megabox.co.kr%2F"></script><script src="/static/pc/js/front.js?v=1592877899585"></script>
<script src="//rum.beusable.net/script/b200617e104748u388/bc4af2fa1e" async="" type="text/javascript"></script><script src="//rum.beusable.net/script/checker/b200617e104748u388/bc4af2fa1e?url=https%3A%2F%2Fwww.megabox.co.kr%2Fmovie-detail%3FrpstMovieNo%3D20019200" async="" type="text/javascript"></script><style type="text/css">/* Chart.js */
/*
...
<div class="header-add-area">
    <div class="cont"><script data-id="U2ACFQVBQ0mneJSt6aNkaA" name="megabox_p/sub/sub@sub_top_1100x80?mlink=343" src="//cast.imp.joins.com/persona.js" async=""></script><script src="//cast.imp.joins.com/body/U2ACFQVBQ0mneJSt6aNkaA/GsTA6yUG5rxDcxq-bCs69ySQ3Ew5BpVUzMmjvvbBvKyEAM4qWzAZAbZCZVNSS0xPM1RUU1pieUZJdVE0SXdnAstB17oOYLgMKAPLQde6DmC4DCg.js"></script><div id="U2ACFQVBQ0mneJSt6aNkaA"><iframe src="//ad.imp.joins.com/html/megabox_p/sub/sub@sub_top_1100x80?_cid=U2ACFQVBQ0mneJSt6aNkaA&amp;_uid=GsTA6yUG5rxDcxq-bCs69ySQ3Ew5BpVUzMmjvvbBvKyEAM4qWzAZAbZCZVNSS0xPM1RUU1pieUZJdVE0SXdnAstB17oOYLgMKAPLQde6DmC4DCg&amp;_ref=https%3A%2F%2Fwww.megabox.co.kr%2Fmovie-detail%3FrpstMovieNo%3D20019200" title="영화상세 상단 배너영역" height="80px" width="100%" name="mliframe" scrolling="no" frameborder="0" topmargin="0" leftmargin="0" marginwidth="0" marginheight="0"></iframe></div></div>
...
<!-- container -->
<div id="bokdContainer" class="container area-ad" style="padding-bottom:200px; display:none">
...
function setTab( idx ){
    switch( idx ) {
        default :
            url 	= location.protocol + "//" + document.domain + "/movie-detail?rpstMovieNo=20019200";
            metaFormat = {
                    'scnTitle'			: '(&#35;살아있다) 주요정보 < 영화 | 라이프시어터, 메가박스'
                    , 'metaTagTitle'	: '(&#35;살아있다) 주요정보 < 영화 | 라이프시어터, 메가박스'
            ...
            break;
        case 1 :
            url 	= location.protocol + "//" + document.domain + "/movie-detail/comment?rpstMovieNo=20019200";
            metaFormat = {
                    'scnTitle'			: '(&#35;살아있다) 한줄평 < 영화 | 라이프시어터, 메가박스'
                    , 'metaTagTitle'	: '(&#35;살아있다) 한줄평 < 영화 | 라이프시어터, 메가박스'
                    , 'metaTagDtls'		: '&#35;살아있다 | 영화에 대해 이야기 나누어 보세요.'
                    , 'metaTagUrl'		: url
            ...
            break;
        case 2 :
            url 	= location.protocol + "//" + document.domain + "/movie-detail/moviepost?rpstMovieNo=20019200";
            metaFormat = {
                    'scnTitle'			: '(&#35;살아있다) 무비포스트 < 영화 | 라이프시어터, 메가박스'
                    , 'metaTagTitle'	: '(&#35;살아있다) 무비포스트 < 영화 | 라이프시어터, 메가박스'
                    , 'metaTagDtls'		: '&#35;살아있다 | 무비포스트로 영화에 대한 감동을 더욱 깊게 남겨보세요.'
                    , 'metaTagUrl'		: url
            ...
            break;
        case 3 :
            url 	= location.protocol + "//" + document.domain + "/movie-detail/trailer?rpstMovieNo=20019200";
            metaFormat = {
                    'scnTitle'			: '(&#35;살아있다) 예고편/스틸컷 < 영화 | 라이프시어터, 메가박스'
                    , 'metaTagTitle'	: '(&#35;살아있다) 예고편/스틸컷 < 영화 | 라이프시어터, 메가박스'
                    , 'metaTagDtls'		: '&#35;살아있다 | 예고편/스틸컷으로 영화를 미리 확인해보세요.'
                    , 'metaTagUrl'		: url
...
<input type="hidden" id="rpstMovieNo" value="20019200">
<input type="hidden" id="movieSynopCn" value="원인불명 증세의 사람들의 공격에 통제 불능에 빠진 도시. <br>영문도 모른 채 잠에서 깬 ‘준우’(유아인)는 아무도 없는 집에 혼자 고립된 것을 알게 된다. <br>데이터, 와이파이, 문자, 전화 모든 것이 끊긴 채 고립된 상황. <br>연락이 두절된 가족에 이어 최소한의 식량마저 바닥이 나자 더 이상 버티기 힘들어진 ‘준우’. <br>하지만 그 순간 건너편 아파트에서 누군가 시그널을 보내온다. <br>또 다른 생존자 ‘유빈’(박신혜)이 아직 살아있음을 알게 된 ‘준우’는 <br>함께 살아남기 위한 방법을 찾아 나서는데...! <br><br>꼭 살아남아야 한다<br>">
...
<input type="hidden" id="rpstMovieNo" name="rpstMovieNo" value="20019200">
	...
	<div class="btn-sns-share-wrap">
		...
		<div class="reserve screen-type col-2">
			<div class="reserve">
						...
						<a href="javascript:fn_bookingForm('20019200','basic');" class="btn reserve" title="영화 예매하기">예매</a>
						<a href="javascript:fn_bookingForm('20019200','MX');" class="btn mx" title="MX관 예매하기">MX</a>
...
//     });
 ...
 //   =2&=10&ibxMovieNmSearch=&pageType=&onairYn=&tabType=my
    ...
    $('.moviePostWitBtn').on('click', function(e) {
        ...
        $('#movieForm').append('<input type="hidden" name="rpstMovieNo" value="20019200">');
   ...
   //     } else if($('.point .box button').attr('class').indexOf('on') ==-1 ){
            ...
            $.ajaxMegaBox({
                ...
                success: function(d) {
                    ...
                    //20190905 한줄평, 댓글 작성시 메세지 불필요  gfn_alertMsgBox({ msg: '한줄평이 ' + title + ' 되었습니다.', callback: fn_oneEndAction(title) });
...
function fn_selectChartData() {
    $.ajaxMegaBox({
        ...
        data: JSON.stringify({
            movieNo: '20019200',
            rpstMovieNo: '20019200',
            kofRpstMovieCd: '20193069'
        }),
        success: function(d) {
...
function fn_bindOneBtnEvent() {
    ...
    $('.deleteOne').off().on('click', function() {
        ...
        gfn_confirmMsgBox(s_onelnEvalDivNm + '을 삭제하시겠습니까?', function() {
...
function fn_selectOneList(onelnEvalDivCd) {
    $.ajaxMegaBox({
        ...
        data: JSON.stringify({ movieNo: '20019200', onelnEvalDivCd: onelnEvalDivCd, currentPage:'1' }),
        success: function(d) {
            var list = d.list;
            ...
            $.each(list, function(i, v) {
             ...
             // 스포일러 신고 글
                ...
                if(isEq) { // 글쓴이 본인일때 나오는 창
                    ...
                    html += '    <button type="button" class="deleteOne" data-no="' + v.onelnEvalNo + '" data-mno="20019200" data-cd="' + v.onelnEvalDivCd + '">삭제 <i class="iconset ico-arr-right-green"></i></button>';
                    html += '</div>';
                } else { // 일반사용자일때 나오는 창
                    html += '<div class="user">';
...
<div class="inner-wrap">
    ...
    <div class="movie-summary infoContent" id="info">
            ...
            <div class="txt">원인불명 증세의 사람들의 공격에 통제 불능에 빠진 도시. <br>영문도 모른 채 잠에서 깬 ‘준우’(유아인)는 아무도 없는 집에 혼자 고립된 것을 알게 된다. <br>데이터, 와이파이, 문자, 전화 모든 것이 끊긴 채 고립된 상황. <br>연락이 두절된 가족에 이어 최소한의 식량마저 바닥이 나자 더 이상 버티기 힘들어진 ‘준우’. <br>하지만 그 순간 건너편 아파트에서 누군가 시그널을 보내온다. <br>또 다른 생존자 ‘유빈’(박신혜)이 아직 살아있음을 알게 된 ‘준우’는 <br>함께 살아남기 위한 방법을 찾아 나서는데...! <br><br>꼭 살아남아야 한다<br></div>
                        ...
                        <p>
                            아직 작성된 무비포스트가 없어요. 첫번째 무비포스트의 주인공이 되어보세요.<br>
                                ...
                                <div class="poster-write">
                                    <a href="#tooltip-layer02" title="무비포스트 쓰기" class="tooltip-click"><i class="iconset ico-write-white"></i> 무비포스트 쓰기</a>
                                    <div id="tooltip-layer02" class="tooltip-cont">
                                        <div class="wrap loginTagClick">
                                            로그인이 필요한 서비스 입니다.<br>
                                            <a href="javaScript:fn_viewLoginPopup('default','pc');" class="font-green" title="로그인 바로가기">로그인 바로가기 <i class="iconset ico-arr-right-green"></i></a>
                                            <button type="button" class="btn-close-tooltip">툴팁 닫기</button>
...
<div class="normalStyle" style="display:none;position:fixed;top:0;left:0;background:#000;opacity:0.7;text-indent:-9999px;width:100%;height:100%;z-index:100;">닫기</div><div class="alertStyle" style="display:none;position:fixed;top:0px;left:0px;background:#000;opacity:0.7;width:100%;height:100%;z-index:5005;"></div></body>
</html>