                                ...
                                <div class="all-list">
                                    ...
                                    <div class="list">
										...
										<ul id="bookingLocal-List">
											<li><button type="button" class="btn" id="10"> <!-- btn on 하면 활성화  / has-issue 하면 왼쪽에 점 생김-->
															...
															<div id="mCSB_4_container"
																...
																<ul>
																	...
																	<li><button id="btn" type="button" brch-no="1359"
																			...
																			brch-bokd-unable-at="N" brch-popup-at="Y"
																			brch-popup-no="988">강남대로(씨티)</button></li>
																	...
																	<li><button id="btn" type="button" brch-no="1003"
																			brch-nm="동대문" brch-eng-nm="Dong Dae Moon" form-at="Y"
																			area-cd="10" area-cd-nm="서울" spclb-yn="N"
																			brch-bokd-unable-at="N" brch-popup-at="N"
																			brch-popup-no="0">동대문</button></li>
																	...
																	<li><button id="btn" type="button" brch-no="1311"
																			brch-nm="상봉" brch-eng-nm="Sangbong" form-at="Y"
																			area-cd="10" area-cd-nm="서울" spclb-yn="N"
																			brch-bokd-unable-at="N" brch-popup-at="Y"
																			brch-popup-no="980">상봉</button></li>
																	<li><button id="btn" type="button" brch-no="1211"
																			brch-nm="상암월드컵경기장"
																			brch-eng-nm="Sangam World Cup Stadium" form-at="Y"
																			area-cd="10" area-cd-nm="서울" spclb-yn="N"
																			brch-bokd-unable-at="N" brch-popup-at="N"
																			brch-popup-no="0">상암월드컵경기장</button></li>
																	<li><button id="btn" type="button" brch-no="1331"
																			brch-nm="성수" brch-eng-nm="SEOUNGSU" form-at="Y"
																			area-cd="10" area-cd-nm="서울" spclb-yn="N"
																			brch-bokd-unable-at="N" brch-popup-at="Y"
																	...
																	<li><button id="btn" type="button" brch-no="1202"
																			brch-nm="신촌" brch-eng-nm="Sin Chon" form-at="Y"
																			area-cd="10" area-cd-nm="서울" spclb-yn="N"
																			brch-bokd-unable-at="N" brch-popup-at="N"
																			brch-popup-no="0">신촌</button></li>
																	<li><button id="btn" type="button" brch-no="1221"
																			brch-nm="은평" brch-eng-nm="Eunpyeong" form-at="N"
																			area-cd="10" area-cd-nm="서울" spclb-yn="N"
																			brch-bokd-unable-at="N" brch-popup-at="N"
																			brch-popup-no="0">은평</button></li>
																	<li><button id="btn" type="button" brch-no="1561"
																			brch-nm="이수" brch-eng-nm="Isu" form-at="Y"
																			area-cd="10" area-cd-nm="서울" spclb-yn="N"
																			brch-bokd-unable-at="N" brch-popup-at="N"
																			brch-popup-no="0">이수</button></li>
																	<li><button id="btn" type="button" brch-no="1321"
																			brch-nm="창동" brch-eng-nm="Changdong" form-at="Y"
																			area-cd="10" area-cd-nm="서울" spclb-yn="N"
																			brch-bokd-unable-at="N" brch-popup-at="Y"
																			brch-popup-no="921">창동</button></li>
																	<li><button id="btn" type="button" brch-no="1351"
																			brch-nm="코엑스" brch-eng-nm="COEX" form-at="Y"
																			area-cd="10" area-cd-nm="서울" spclb-yn="N"
																			brch-bokd-unable-at="N" brch-popup-at="N"
																			brch-popup-no="0">코엑스</button></li>
																	<li><button id="btn" type="button" brch-no="1212"
																			brch-nm="홍대" brch-eng-nm="Hongdae" form-at="Y"
																			area-cd="10" area-cd-nm="서울" spclb-yn="N"
																			brch-bokd-unable-at="N" brch-popup-at="Y"
																			brch-popup-no="1003">홍대</button></li>
																	<li><button id="btn" type="button" brch-no="1571"
																			brch-nm="화곡" brch-eng-nm="Hwagok" form-at="Y"
																			area-cd="10" area-cd-nm="서울" spclb-yn="N"
																			brch-bokd-unable-at="N" brch-popup-at="Y"
																			brch-popup-no="999">화곡</button></li>
																	<li><button id="btn" type="button" brch-no="1562"
																			brch-nm="ARTNINE" brch-eng-nm="ARTNINE" form-at="Y"
																			area-cd="10" area-cd-nm="서울" spclb-yn="N"
																			brch-bokd-unable-at="N" brch-popup-at="Y"
																			brch-popup-no="955">ARTNINE</button></li>
																</ul>
															</div>
